...
const createEvent = async (req, res) => {
  try {
    console.log("Request Events Headers:", req.headers);
    console.log("Request Events Body:", req.body);
    console.log("Uploaded Events Files:", req.files); // Should contain uploaded files
